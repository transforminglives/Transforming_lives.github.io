...
<div class="container">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Listado de noticias</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
        
                <a class="btn btn-outline-success" href="/createHome">Ingresar</a>
                <a class="btn btn-outline-danger" href="/homed">Desactivados</a>
          </div>
        </div>
      </div>
            ...
            @foreach ($home as $item)
                <tr>
                  ...
                  <td>
                    ...
                    <a type="button" class="btn btn-outline-danger" href="/statusHome/{{$item->id}}">Desactivar</a>
                  </td>
                </tr>
            @endforeach
